-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('Nam', 'Nß╗»', 'Kh├íc');
...
CREATE TABLE "reading_sessions" (
    ...
    "last_location" TEXT,
    "last_read_timestamp" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "reading_sessions_user_id_book_id_key" ON "reading_sessions"("user_id", "book_id");
